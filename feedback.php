...
<div class="col-md-6 panel" style="background-image:url(image/bg.png; min-height:430px;">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/1.JPG" width=100 height=100 alt="Developer Image" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://github.com/raiyan-ahmed" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Raiyan Ahmed</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+880-1791271560</h4>
		<h4 style="font-family:'typo' ">rfraiyan123@gmail.com</h4>
		<h4 style="font-family:'typo' ">Sylhet, Bangladesh</h4></div></div>
		</p>
      </div>
